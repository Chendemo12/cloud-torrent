...
import (
	...
	"github.com/Chendemo12/cloud-torrent/engine"
	"github.com/Chendemo12/cloud-torrent/static"
...
type Server struct {
	//config
	Title      string `json:"title" help:"Title of this instance" env:"TITLE"`
	Port       int    `json:"port" help:"Listening port" env:"PORT"`
	Host       string `json:"host" help:"Listening interface (default all)"`
	Auth       string `json:"auth" help:"Optional basic auth in form 'user:password'" env:"AUTH"`
	ConfigPath string `json:"config_path" help:"Configuration file path"`
	KeyPath    string `json:"key_path" help:"TLS Key file path"`
	CertPath   string `json:"cert_path" help:"TLS Certicate file path" short:"r"`
	Log        bool   `json:"log" help:"Enable request logging"`
	Open       bool   `json:"open" help:"Open now with your default browser"`
	//http handlers
